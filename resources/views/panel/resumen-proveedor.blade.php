...
<head>
    <meta charset="UTF-8">
    <title>Resumen de Órdenes de Compra Nº</title>
    <style>
        body {
        ...
        td.numero { width: 10%; text-align: left; }
        td.nombre { width: 60%; text-align: left; padding-left: 8px; }
        td.valor { width: 30%; text-align: right; padding-right: 10px; }
...
<div class="informe">
    ...
    <div class="encabezado">
        ...
        <div class="centro">
            ...
            <h2>RESUMEN DE ÓRDENES DE COMPRA Nº</h2>
            <div class="periodo">
    ...
    <!-- ================= TABLA ARRIBA CON NUMERO, NOMBRE Y VALOR ================= -->
